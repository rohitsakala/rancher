...
// ExponentialBackOffValues are values for the ratelimiting func when OCI registry sends 429 status codes.
...
type RepoSpec struct {
	...
	// ExponentialBackOffValues are values given to the ratelimiting function for retry policy when
	// registry sends 429 status
